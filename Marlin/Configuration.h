...
#define STRING_CONFIG_H_AUTHOR "JF" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 32.4, 8.3, 0.15 }
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_HEIGHT      0.13   // (mm) Z height of nozzle at leveling points
